...
class MyCustomerSearchField extends StatefulWidget {
  ...
  MyCustomerSearchField({Key key, this.title = "", this.labelText = "", this.controller, this.focusNode, this.onSelected, this.hint, this.maxLines = 1, this.small = 1, this.medium = 3, this.large = 4, this.xlarge = 5, this.padding = 8, this.isRequired = false}) : super(key: key);
  @override
  _MyCustomerSearchFieldState createState() => _MyCustomerSearchFieldState();
}
...
class _MyCustomerSearchFieldState extends State<MyCustomerSearchField> {
 ...
 Future<List<Cliente>> _search(String data) async {
  ...
  _selectClienteAndClose(Cliente cliente){
    ...
    String data = "${cliente.nombres} ${cliente.apellidos}";
